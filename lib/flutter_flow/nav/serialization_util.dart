      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case BrandPartnersRow:
            return BrandPartnersRow(data);
          case PreferenceCategoriesRow:
            return PreferenceCategoriesRow(data);
          case ReviewMediaRow:
            return ReviewMediaRow(data);
          case PartnersRow:
            return PartnersRow(data);
          case UserPreferencesRow:
            return UserPreferencesRow(data);
          case UserPreferenceValuesRow:
          ...
          case RewardPointsRow:
            return RewardPointsRow(data);
          case BrandEthicsRow:
            return BrandEthicsRow(data);
          case FiltersRow:
          ...
          case FaqsOptionsRow:
            return FaqsOptionsRow(data);
          case ManufacturingPracticesRow:
            return ManufacturingPracticesRow(data);
          case BrandMaterialsRow:
            return BrandMaterialsRow(data);
          case EthicalManufacturingRow:
            return EthicalManufacturingRow(data);
