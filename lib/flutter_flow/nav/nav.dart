...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => const GetStartedScreenWidget(),
        ),
        FFRoute(
          name: 'LoginScreen',
          path: '/loginScreen',
        ...
        FFRoute(
          ...
          builder: (context, params) => const SetupProfileScreenWidget(),
        ),
        FFRoute(
          name: 'BirthDateScreen',
          path: '/birthDateScreen',
          builder: (context, params) => const BirthDateScreenWidget(),
        ),
        FFRoute(
          name: 'LoadingScreen',
          path: '/loadingScreen',
        ...
        FFRoute(
          ...
          path: '/validationCodeScreen',
          builder: (context, params) => ValidationCodeScreenWidget(
        ...
        FFRoute(
          name: 'ForgotPasswordValidationCodeScreen',
          path: '/forgotPasswordValidationCodeScreen',
          builder: (context, params) =>
              ForgotPasswordValidationCodeScreenWidget(
            email: params.getParam(
              'email',
              ParamType.String,
            ),
        ...
        FFRoute(
          ...
          path: '/finishQuiz',
          requireAuth: true,
          builder: (context, params) => const FinishQuizWidget(),
        ),
        FFRoute(
          name: 'MyModie',
          path: '/myModie',
          requireAuth: true,
          builder: (context, params) => const MyModieWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'MyModie_Profile',
          path: '/myModieProfile',
          requireAuth: true,
          builder: (context, params) => const MyModieProfileWidget(),
        ),
        FFRoute(
          name: 'MyModie_Invite',
          path: '/myModieInvite',
          builder: (context, params) => const MyModieInviteWidget(),
        ),
        FFRoute(
          name: 'QuizProfile',
          path: '/quizProfile',
          builder: (context, params) => QuizProfileWidget(
        ...
        FFRoute(
          name: 'MyShippingAdress',
          path: '/myShippingAdress',
          builder: (context, params) => const MyShippingAdressWidget(),
        ),
        FFRoute(
          name: 'AddAdress',
          path: '/addAdress',
          builder: (context, params) => const AddAdressWidget(),
        ),
        FFRoute(
          name: 'QuizProfileCopy',
          path: '/quizProfileCopy',
          builder: (context, params) => QuizProfileCopyWidget(
            type: params.getParam(
              'type',
              ParamType.String,
            ),
