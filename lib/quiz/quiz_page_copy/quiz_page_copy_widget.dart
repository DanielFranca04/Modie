...
import 'quiz_page_copy_model.dart';
export 'quiz_page_copy_model.dart';

class QuizPageCopyWidget extends StatefulWidget {
  const QuizPageCopyWidget({super.key});

  @override
  State<QuizPageCopyWidget> createState() => _QuizPageCopyWidgetState();
}

class _QuizPageCopyWidgetState extends State<QuizPageCopyWidget>
    with TickerProviderStateMixin {
  late QuizPageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizPageCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<QuizRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<QuizRow> quizPageCopyQuizRowList = snapshot.data!;

        final quizPageCopyQuizRow = quizPageCopyQuizRowList.isNotEmpty
            ? quizPageCopyQuizRowList.first
            : null;
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(-1.5, 1.0),
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 12.0, 0.0, 0.0),
                                        child: Text(
                                          'Please select up to ${quizPageCopyQuizRow?.minqstnumb?.toString()} options',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Montserrat',
                            ...
                            onTap: () async {
                              if (FFAppState().i <
                                ...
                                if (FFAppState().i ==
                                  ...
                                  context.pushNamed('QuizPageCopy');
                                }
                              }
                            },
                            child: ClipRRect(
