...
class QuizProfileWidget extends StatefulWidget {
  const QuizProfileWidget({
    super.key,
    required this.type,
  });
  ...
  @override
  State<QuizProfileWidget> createState() => _QuizProfileWidgetState();
}

class _QuizProfileWidgetState extends State<QuizProfileWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<QuizRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<QuizRow> quizProfileQuizRowList = snapshot.data!;

        final quizProfileQuizRow = quizProfileQuizRowList.isNotEmpty
            ? quizProfileQuizRowList.first
            : null;
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      'Please select up to ${quizProfileQuizRow?.minqstnumb?.toString()} options.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Montserrat',
